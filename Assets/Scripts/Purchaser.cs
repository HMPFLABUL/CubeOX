...
public class Purchaser : MonoBehaviour, IStoreListener
    ...
    private static string sign_Hash = "sign_hash";
    ...
    private static string sign_HashGooglePlay = "sign_hash";
        void Start()
        {
        ...
        builder.AddProduct(sign_Hash, ProductType.NonConsumable, new IDs() { {sign_HashGooglePlay, GooglePlay.Name} });
    ...
    public void BuySignHash()
    {
        BuyProductID(sign_Hash);
    }
        ...
        else if(String.Equals(args.purchasedProduct.definition.id, sign_Hash, StringComparison.Ordinal))
        {
            Debug.Log("Huj kupiłes");
